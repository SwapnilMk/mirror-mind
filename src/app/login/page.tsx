    ...
    <div className="flex flex-col min-h-screen bg-[#080810] px-6 pt-20">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mb-6">
        ...
        <div className="text-right">
          <button type="button" className="text-violet-400 text-xs font-medium">Forgot password?</button>
        </div>
      ...
      <p className="text-zinc-600 text-xs text-center mb-10">
        ...
        <Link href="/signup" className="text-violet-400 font-medium hover:underline">Sign up</Link>
      </p>
    </div>
  )
}
