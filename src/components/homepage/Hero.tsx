    ...
    <section className="relative overflow-hidden pt-20 pb-32 md:pt-32 md:pb-48">
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8 leading-[1.1]">
          Reflect Your <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primary/80 to-accent">Inner World</span>
        </h1>
        
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          MirrorMind helps you capture your thoughts, emotions, and growth in a digital sanctuary designed for clarity and peace.
        </p>
        ...
        <div className="mt-20 relative max-w-5xl mx-auto">
          <div className="relative z-10 rounded-2xl border border-white/20 bg-white/5 backdrop-blur-2xl shadow-2xl overflow-hidden aspect-video group">
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-white/20 font-black text-9xl tracking-tighter select-none">MIRROR</div>
            </div>
            
            {/* Inner "Mirror" Content */}
            <div className="absolute bottom-8 left-8 right-8 grid grid-cols-3 gap-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="h-32 rounded-xl bg-white/10 border border-white/10 p-4 transition-transform group-hover:-translate-y-2 delay-[i*100ms]">
